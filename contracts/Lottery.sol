...
contract Lottery{
    ...
    /**
     * @dev 베팅과 정답 체크를 한다. 유저는 0.005 ETH를 보내야 하고, 베팅을 1byte 글자를 보낸다.
    ...
    //Bet
    /**
     * @dev 배팅을 한다. 유저는 0.005 ETH를 보내야하고, 베팅을 1byte 글자를 보낸다.
     * 큐에 저장된 베팅 정보는 이후 distribute 함수에서 해결된다.
     * @param challenges 유저가 베팅하는 글자
     * @return 함수가 잘 수행되었는지 확인하는 bool 값
     */
    ...
    function setAnswerForTest(bytes32 answer) public returns (bool result){
        require(msg.sender == owner, "Only owner can sset the answer for test mode");
